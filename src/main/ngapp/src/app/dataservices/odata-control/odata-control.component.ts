...
export class OdataControlComponent implements OnChanges {
  ...
  public selectGroupIcon: string = 'fa-arrow-circle-up';
  public columnGroupIcon: string = 'fa-arrow-circle-down';
  public whereGroupIcon: string = 'fa-arrow-circle-down';
  public orderGroupIcon: string = 'fa-arrow-circle-down';
  public formatGroupIcon: string = 'fa-arrow-circle-up';
  ...
  public handleAccordionGroupChange(group: string, event: boolean): void {
    if (group === 'select')
      this.selectGroupIcon = event ? 'fa-arrow-circle-up' : 'fa-arrow-circle-down';
    else if (group === 'column')
      this.columnGroupIcon = event ? 'fa-arrow-circle-up' : 'fa-arrow-circle-down';
    else if (group === 'where')
      this.whereGroupIcon = event ? 'fa-arrow-circle-up' : 'fa-arrow-circle-down';
    else if (group === 'order')
      this.orderGroupIcon = event ? 'fa-arrow-circle-up' : 'fa-arrow-circle-down';
    else if (group === 'format')
      this.formatGroupIcon = event ? 'fa-arrow-circle-up' : 'fa-arrow-circle-down';
  }
}
